...
简单地来说，当我们在浏览器上输入URL的敲下回车的时候。
 ...
 ![]({{site.baseurl}}/images/images/http/1.jpeg)
...
各个部分的介绍如下表：
![]({{site.baseurl}}/images/images/http/0.jpeg)
以一个实际例子来说：
...
主体
 ...
 可能的响应报文如下：
     ...
     Hi,I'm a message!
下面是一个POST方法示例：
   ![]({{site.baseurl}}/images/images/http/2.jpeg)
...
`<源IP地址、源端口号、目地IP地址、目地端口号>`这4个值唯一定义了一条TCP连接。
 一个TCP分组如下：
  ![]({{site.baseurl}}/images/images/http/3.jpeg)
一个典型的TCP客户端和服务器的通信过程如下：
 ![]({{site.baseurl}}/images/images/http/4.jpeg)
